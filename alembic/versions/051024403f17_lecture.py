...
Revision ID: 051024403f17
Revises: 
Create Date: 2023-03-07 20:37:24.984696
...
def upgrade() -> None:
    ...
    sa.Column('question_type', postgresql.ENUM('MultipleChoice', 'TrueFalse', 'ShortAnswer', name='questiontype'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table('question_answers', schema='lqs')
